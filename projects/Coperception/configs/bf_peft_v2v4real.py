...
custom_imports = dict(
    imports=['projects.Coperception.coperception'],
...
voxel_size = [0.150, 0.075, 0.2]  # [0.20, 0.075, 0.2]
# point_cloud_range = [-140., -40., -5., 140., 40., 3.]
...
model = dict(
    ...
    data_preprocessor=dict(
        ...
        voxelize_cfg=dict(
            ...
            point_cloud_range=gt_range,
            voxel_size=voxel_size,
            max_voxels=[120000, 160000],  # *max_voxel=32000
            voxelize_reduce=True,
        ),
    ),
    pts_voxel_encoder=dict(type='HardSimpleVFE', num_features=num_pts_feats),
    pts_middle_encoder=dict(
        type='BEVFusionSparseEncoderPEFT',
        in_channels=num_pts_feats - 1,
    ...
    bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            pc_range=gt_range,
            post_center_range=[-120.0, -50.0, -10.0, 120.0, 50.0, 10.0],
            score_threshold=0.0,
            out_size_factor=8,
            voxel_size=voxel_size,
            # code_size=10
...
train_pipeline = [
    ...
    dict(type='PointsRangeFilter', point_cloud_range=gt_range),
    dict(type='ObjectRangeFilter', point_cloud_range=gt_range),
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            type=dataset_type,
            data_root=data_root,
            ann_file='v2v4real_infos_train_x.pkl',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='v2v4real_infos_test_x.pkl',
...
val_evaluator = dict(
    type='V2V4RealMetric',
    ann_file=data_root + 'v2v4real_infos_test_x.pkl',
    pcd_limit_range=gt_range,  # the final range for evaluation
