...
class WaymoMetric(KittiMetric):
    ...
    def waymo_evaluate(
        ...
        if metric == 'mAP':
            ...
            ap_dict['Overall/L1 mAPH'] = (ap_dict['Vehicle/L1 mAPH'] +
                                          ap_dict['Pedestrian/L1 mAPH'] +
                                          ap_dict['Cyclist/L1 mAPH']) / 3
            ap_dict['Overall/L2 mAP'] = (ap_dict['Vehicle/L2 mAP'] +
                                         ap_dict['Pedestrian/L2 mAP'] +
                                         ap_dict['Cyclist/L2 mAP']) / 3
            ap_dict['Overall/L2 mAPH'] = (ap_dict['Vehicle/L2 mAPH'] +
            ...
            for idx, key in enumerate(ap_dict.keys()):
                ...
                if idx % 3 == 0:  # mAPL
                    ...
                    ap_dict[key] = float(mAPH_splits[split_idx].split(']')[0])
            ap_dict['Overall mAPL'] = (ap_dict['Vehicle mAPL'] +
                                       ap_dict['Pedestrian mAPL'] +
                                       ap_dict['Cyclist mAPL']) / 3
            ap_dict['Overall mAP'] = (ap_dict['Vehicle mAP'] +
                                      ap_dict['Pedestrian mAP'] +
                                      ap_dict['Cyclist mAP']) / 3
            ap_dict['Overall mAPH'] = (ap_dict['Vehicle mAPH'] +
