...
class NuScenesMetric(BaseMetric):
    ...
    def get_attr_name(self, attr_idx: int, label_name: str) -> str:
        ...
        if (label_name == 'car' or label_name == 'bus' or label_name == 'truck'
                or label_name == 'trailer'
                or label_name == 'construction_vehicle'):
            if (AttrMapping_rev2[attr_idx] == 'vehicle.moving'
            ...
            if (AttrMapping_rev2[attr_idx] == 'pedestrian.moving'
            ...
            if (AttrMapping_rev2[attr_idx] == 'cycle.with_rider'
    ...
    def _format_camera_bbox(
        ...
        for i, det in enumerate(mmengine.track_iter_progress(results)):
            ...
            boxes, attrs = cam_nusc_box_to_global(
                self.data_infos[frame_sample_idx],
                boxes,
                attrs,
                classes,
