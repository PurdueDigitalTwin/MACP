...
class EvalPanoptic:
    r"""Evaluate panoptic results for Semantickitti and NuScenes. Please refer
    to the `semantic kitti api.
    ...
    def evaluate(
        self,
        gt_labels: List[Dict[str, np.ndarray]],
        seg_preds: List[Dict[str, np.ndarray]],
    ) -> Dict[str, float]:
...
def panoptic_seg_eval(
    ...
    """
    panoptic_seg_eval = EvalPanoptic(
        classes,
        thing_classes,
        stuff_classes,
        min_num_points,
