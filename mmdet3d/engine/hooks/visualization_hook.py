...
class Det3DVisualizationHook(Hook):
    ...
    def after_val_iter(
        ...
        if self.vis_task in ['lidar_det', 'multi-modality_det', 'lidar_seg']:
            assert ('lidar_path'
                    in outputs[0]), 'lidar_path is not in outputs[0]'
    ...
    def after_test_iter(
        ...
        for data_sample in outputs:
            ...
            if self.vis_task in [
                ...
                assert ('img_path'
                        in data_sample), 'img_path is not in data_sample'
            ...
            if self.vis_task in [
                ...
                assert ('lidar_path'
                        in data_sample), 'lidar_path is not in data_sample'
                ...
                if self.test_out_dir is not None:
                    o3d_save_path = (
                        osp.basename(lidar_path).split('.')[0] + '.png')
