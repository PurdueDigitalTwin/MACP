...
class MVXTwoStageDetector(Base3DDetector):
    ...
    def with_img_shared_head(self):
        ...
        return (hasattr(self, 'img_shared_head')
                and self.img_shared_head is not None)
    ...
    def with_fusion(self):
        ...
        return (hasattr(self, 'pts_fusion_layer')
    ...
    def with_voxel_encoder(self):
        ...
        return (hasattr(self, 'voxel_encoder')
                and self.voxel_encoder is not None)

    @property
    def with_middle_encoder(self):
        """bool: Whether the detector has a middle encoder."""
        return (hasattr(self, 'middle_encoder')
                and self.middle_encoder is not None)
