...
class PointNet2SAMSG(BasePointNet):
    ...
    def __init__(
        ...
        num_samples: TwoTupleIntType = (
            (32, 32, 64),
            (32, 32, 64),
            (32, 32, 32),
        ),
        sa_channels: ThreeTupleIntType = (
            ((16, 16, 32), (16, 16, 32), (32, 32, 64)),
            ((64, 64, 128), (64, 64, 128), (64, 96, 128)),
            ((128, 128, 256), (128, 192, 256), (128, 256, 256)),
        ),
        aggregation_channels: Tuple[int] = (64, 128, 256),
        fps_mods: TwoTupleStrType = (('D-FPS'), ('FS'), ('F-FPS', 'D-FPS')),
        fps_sample_range_lists: TwoTupleIntType = ((-1), (-1), (512, -1)),
        ...
        assert (len(num_points) == len(radii) == len(num_samples) ==
                len(sa_channels))
    ...
    def forward(self, points: Tensor):
        ...
        indices = (
            xyz.new_tensor(range(num_points)).unsqueeze(0).repeat(batch,
                                                                  1).long())
