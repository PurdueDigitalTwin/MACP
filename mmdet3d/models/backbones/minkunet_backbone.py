    ...
    def __init__(
        ...
        if sparseconv_backend == 'torchsparse':
            ...
            residual_block = (
                ...
                if block_type == 'basic' else TorchSparseBottleneck)
            ...
            residual_block = (
                SparseBasicBlock
                if block_type == 'basic' else SparseBottleneck)
            ...
            residual_block = (
                MinkowskiBasicBlock
                if block_type == 'basic' else MinkowskiBottleneck)
