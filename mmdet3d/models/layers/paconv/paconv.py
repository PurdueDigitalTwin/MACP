...
class PAConv(nn.Module):
    ...
    def __init__(
        ...
        weight_bank = (
            weight_bank.permute(1, 0, 2).reshape(
        ...
        self.activate = (
            build_activation_layer(act_cfg) if act_cfg is not None else None)
...
class PAConvCUDA(PAConv):
    ...
    See the `paper <https://arxiv.org/pdf/2103.14635.pdf>`_ appendix Sec. D
    formore detailed descriptions.
    """
