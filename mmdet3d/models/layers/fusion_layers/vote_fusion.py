...
class VoteFusion(nn.Module):
    ...
    def forward(
        self,
        imgs: List[Tensor],
        bboxes_2d_rescaled: List[Tensor],
        ...
        for i, data in enumerate(
            ...
            if bbox_num == 0:
                ...
                xz = (
                    ray_angle[:, [0, 2]] /
                    (ray_angle[:, [1]] + EPS) * seed_3d_expanded[:, [1]] -
                    seed_3d_expanded[:, [0, 2]])
