...
class PartAggregationROIHead(Base3DRoIHead):
    ...
    def with_semantic(self):
        ...
        return (hasattr(self, 'semantic_head')
    ...
    def _assign_and_sample(
        ...
        batch_gt_instances_ignore: InstanceList,
    ) -> List[SamplingResult]:
        ...
        for batch_idx in range(len(rpn_results_list)):
            ...
            cur_gt_instances_3d.bboxes_3d = (
                cur_gt_instances_3d.bboxes_3d.tensor)
            ...
            if isinstance(self.bbox_assigner, list):
                for i, assigner in enumerate(self.bbox_assigner):
                    ...
                    # gt inds (1-based)
                    gt_inds_arange_pad = (
                        gt_per_cls.nonzero(as_tuple=False).view(-1) + 1)
    ...
    def _bbox_forward(self, feats_dict: Dict, voxel_dict: Dict,
        ...
        """
        pooled_seg_feats = self.seg_roi_extractor(
