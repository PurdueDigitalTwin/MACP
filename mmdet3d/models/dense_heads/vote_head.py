...
class VoteHead(BaseModule):
    ...
    def _extract_input(self, feat_dict: dict) -> tuple:
        ...
        # for imvotenet
        if ('seed_points' in feat_dict and 'seed_features' in feat_dict
                and 'seed_indices' in feat_dict):
    ...
    def loss_by_feat(
        ...
        **kwargs,
        ...
        one_hot_size_targets_expand = (
            one_hot_size_targets.unsqueeze(-1).repeat(1, 1, 1, 3).contiguous())
